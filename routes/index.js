...
const id = require('mongoose').Types.ObjectId.isValid(req.params.id) ? req.params.id : null; if (!id) return next(new Error('Invalid ID')); Todo.findById(id, function (err, todo) {
