...
app.use(session({ domain: 'yourdomain.com', secret: 'keyboard cat', name: 'connect.sid', cookie: { path: '/', expires: new Date(Date.now() + 24 * 60 * 60 * 1000), httpOnly: true, secure: true } }))
